    ...
    for(let i=0; i<7; i++){
      ...
      if (today.getDate() === currentDate.getDate()){
        ...
        if (hours < 10) {
          ...
          if (minutes === 0){
            // Đúng giờ chẵn (ví dụ: 13:00) → bắt đầu từ 13:30
            currentDate.setHours(hours, 30, 0, 0)
          }else if (minutes <= 30){
            // Từ 00:01 đến 30:00 → bắt đầu từ xx:30
            currentDate.setHours(hours, 30, 0, 0)
          }else{
            // Từ 30:01 trở đi → nhảy sang giờ tiếp theo, phút 00
      ...
      while(currentDate < endTime){
        ...
        const isSlotAviailable = docInfo.slots_booked[slotDate]&& docInfo.slots_booked[slotDate].includes(slotTime) ? false : true
