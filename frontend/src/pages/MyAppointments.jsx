...
export const MyAppointments = () => {
  ...
  const { backendUrl,backendUrl_user_service, token, getDoctorsData } = useContext(AppContext)
  ...
  const getUserAppointments = async () =>{
    try{
      ...
      const {data} = await axios.get(backendUrl_user_service+ '/user/appointments', {headers:{token}})
  ...
  const cancelAppointment = async (appointmentId)=>{
    ...
    try{
      ...
      const {data} =await axios.post(backendUrl_user_service+'/user/cancel-appointment', {appointmentId}, {headers:{token}})
      if(data.success){
    ...
    const options = {
      ...
      handler: async (response) =>{
        ...
        try{
          ...
          const {data} = await axios.post(backendUrl+'/api/user/verityRazorpay', response, {headers:{token}})
          if(data.success){
            getUserAppointments()
